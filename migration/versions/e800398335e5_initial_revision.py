...
Revision ID: e800398335e5
Revises: 
Create Date: 2026-01-21 17:45:27.209908
...
def upgrade() -> None:
    ...
    sa.Column('gender', sa.Enum('MAIL', 'FEMAIL', name='genderenum', create_type=False), nullable=False),
    ...
    sa.Column('status', sa.Enum('PUBLISHED', 'DELETE', 'UNDER_MODERATION', 'DRAFT', 'SCHEDULED', name='statuspost'), server_default=sa.text("'DRAFT'"), nullable=False),
